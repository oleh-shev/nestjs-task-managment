...
describe('TasksService', () => {
  ...
  describe('createTask', () => {
    ...
    it('should call taskRepository.createTask() and successfully retrieve and return the new task', async () => {
  ...
  describe('deleteTask', () => {
    it('should call taskRepository.deleteTask() and delete task', async () => {
